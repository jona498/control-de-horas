document.addEventListener('DOMContentLoaded', () => {
    ...
    // ¡NUEVO! Contextos de los gráficos
    ...
    // ¡NUEVO! Instancias de los gráficos
    let projectChartInstance = null;
    let jpChartInstance = null;

    // --- FUNCIONES DE ALMACENAMIENTO (Sin cambios) ---
    // ... (loadFromStorage, saveTasksToStorage, saveSuggestionsToStorage, saveDayTypesToStorage, saveSettingsToStorage, saveAllDataToStorage)
    ...
    // ... (loadSettingsIntoUI, handleSaveSettings, prepareBackupData, handleExportBackup, handleImportBackup, handleFileSelected)
    ...
    // ... (renderSuggestionManagers, handleDeleteSuggestion, handleRenameSuggestion)
    ...
    function navigateTo(view) {
        ...
        if (view === 'calendar') {
            ...
            handleGenerateSummary(); // Generar resumen y gráficos
    ...
    /**
     * Controlador principal para la pestaña de Resumen.
     */
    function handleGenerateSummary() {
        ...
        // 1. Obtener todas las tareas del rango
    ...
    /**
     * ¡NUEVO! Solo agrega datos, no dibuja. Devuelve el objeto de datos.
     */
    ...
    /**
     * ¡NUEVO! Dibuja la tabla de Proyectos.
     */
    ...
    /**
     * ¡NUEVO! Dibuja los dos gráficos de pastel.
     */
    function renderCharts(projectData, jpData) {
        // 1. Destruir gráficos antiguos si existen (MUY IMPORTANTE)
    ...
    /**
     * ¡NUEVO! Helper para generar colores aleatorios para los gráficos.
     */
    ...
    /**
     * ¡ACTUALIZADO! Llama al nuevo `handleGenerateSummary`.
     */
    function generateAndDownloadCSV() {
        ...
        const tasks = getTasksForDateRange(startDate, endDate);
        // ... (resto de la función de CSV igual que antes) ...
    ...
    // ... (populateSuggestionDatalists, renderCalendar, selectDay, renderTasksInSidebar)
    ...
    // ... (updateSidebarSummary, updateDaySummaryInGrid, handleAddTask, handleTaskListClick, setDayType)
